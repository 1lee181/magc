    ...
    <div class="cards-grid">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="card-meta">
            <?php if ($e['event_date']): echo date('M j, Y', strtotime($e['event_date'])); endif; ?>
...
<section id="partners" class="section">
  ...
  <?php else: ?>
  <div class="section-inner"><p style="color:var(--taupe); font-size:0.9rem;">No partners to display yet.</p></div>
  <?php endif; ?>
</section>
