...
<head>
  ...
  <title>VentureHub | McMaster Venture Capital Club</title>
...
══════════════════════════════════════════ -->
  <nav class="navbar">
    <a class="navbar-brand" href="<?= BASE ?>/">VentureHub</a>
          ...
          <?php foreach ($execs as $ex): ?>
            <div class="exec-card">
              <?php if (!empty($ex['photo_url'])): ?>
                <img class="exec-photo" src="<?= htmlspecialchars($ex['photo_url']) ?>" alt="<?= htmlspecialchars($ex['name']) ?>">
              <?php else: ?>
...
══════════════════════════════════════════ -->
  <section id="join" class="section section-alt">
    <div class="section-inner">
      ...
      <div class="section-rule"></div>
      <p class="section-lead">Fill out the interest form below and we will be in touch.</p>
...
══════════════════════════════════════════ -->
  <section id="contact">
    ...
    <div class="section-rule" style="margin-left:auto;margin-right:auto;"></div>
